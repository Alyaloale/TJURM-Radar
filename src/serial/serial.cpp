...
void send_hero(){
    ...
    robot_interaction_data_t robot_interaction_data;
    robot_interaction_data.sender_id = Data::self_color == rm::ArmorColor::ARMOR_COLOR_RED? 9 : 109;
    robot_interaction_data.receiver_id = Data::self_color == rm::ArmorColor::ARMOR_COLOR_RED? 1 : 101;
    ...
    if(Data::map_robot_data.hero_position_x != 0 && Data::map_robot_data.hero_position_y != 0){
        ...
        {
            if(Data::map_robot_data.infantry_3_position_x <= 1072.2
                || Data::map_robot_data.infantry_4_position_x <= 1072.2
                || Data::map_robot_data.sentry_position_x <= 1072.2)
            robot_interaction_data.user_data.radar_cmd = 0x03;
            else if(Data::map_robot_data.infantry_3_position_x <= 2035.2 && Data::map_robot_data.infantry_3_position_y >= 1248.7 || Data::map_robot_data.infantry_3_position_x <= 1267.1
                || Data::map_robot_data.infantry_4_position_x <= 2035.2 && Data::map_robot_data.infantry_4_position_y >= 1248.7 || Data::map_robot_data.infantry_4_position_x <= 1267.1
                || Data::map_robot_data.sentry_position_x <= 2035.2 && Data::map_robot_data.sentry_position_y >= 1248.7 || Data::map_robot_data.sentry_position_x <= 1267.1)
            robot_interaction_data.user_data.radar_cmd = 0x02;
            else if(Data::map_robot_data.infantry_3_position_x <= 1401.8
                || Data::map_robot_data.infantry_4_position_x <= 1401.8
                || Data::map_robot_data.sentry_position_x <= 1401.8)
            robot_interaction_data.user_data.radar_cmd = 0x01;
            else
            robot_interaction_data.user_data.radar_cmd = 0x00;
        }
        else
        {
            if(2800 - Data::map_robot_data.infantry_3_position_x <= 1072.2
                || 2800 - Data::map_robot_data.infantry_4_position_x <= 1072.2
                || 2800 - Data::map_robot_data.sentry_position_x <= 1072.2)
            robot_interaction_data.user_data.radar_cmd = 0x03;
            else if(2800 - Data::map_robot_data.infantry_3_position_x <= 2035.2 && 1500 - Data::map_robot_data.infantry_3_position_y >= 1248.7 || 2800 - Data::map_robot_data.infantry_3_position_x <= 1267.1
                || 2800 - Data::map_robot_data.infantry_4_position_x <= 2035.2 && 1500 - Data::map_robot_data.infantry_4_position_y >= 1248.7 || 2800 - Data::map_robot_data.infantry_4_position_x <= 1267.1
                || 2800 - Data::map_robot_data.sentry_position_x <= 2035.2 && 1500 - Data::map_robot_data.sentry_position_y >= 1248.7 || 2800 - Data::map_robot_data.sentry_position_x <= 1267.1)
            robot_interaction_data.user_data.radar_cmd = 0x02;
            else if(2800 - Data::map_robot_data.infantry_3_position_x <= 1401.8
                || 2800 - Data::map_robot_data.infantry_4_position_x <= 1401.8
                || 2800 - Data::map_robot_data.sentry_position_x <= 1401.8)
            robot_interaction_data.user_data.radar_cmd = 0x01;
            else
            robot_interaction_data.user_data.radar_cmd = 0x00;
        }
...
void send_map(){
    ...
    Data::map_robot_data.sentry_position_x = Data::enemy_info[0].map_pos.x;
    ...
    Data::map_robot_data.infantry_3_position_y = Data::enemy_info[3].map_pos.y;
    Data::map_robot_data.infantry_4_position_x = Data::enemy_info[4].map_pos.x;
    Data::map_robot_data.infantry_4_position_y = Data::enemy_info[4].map_pos.y;
    Data::map_robot_data.infantry_5_position_x = Data::enemy_info[5].map_pos.x;
    Data::map_robot_data.infantry_5_position_y = Data::enemy_info[5].map_pos.y;
...
void data_process(uint8_t* data, int size){
    ...
    // 雷达标记进度数据
        ...
        Data::enemy_info[0].is_debuff = Data::radar_mark_data.mark_sentry_progress;
        Data::enemy_info[1].is_debuff = Data::radar_mark_data.mark_hero_progress;
        Data::enemy_info[2].is_debuff = Data::radar_mark_data.mark_engineer_progress;
        Data::enemy_info[3].is_debuff = Data::radar_mark_data.mark_standard_3_progress;
        Data::enemy_info[4].is_debuff = Data::radar_mark_data.mark_standard_4_progress;
        //Data::enemy_info[5].is_debuff = Data::radar_mark_data.mark_standard_5_progress >= 100;
        std::cout<<Data::enemy_info[1].is_debuff<<std::endl;
    }
    // 雷达自主决策信息同步
    ...
    // 机器人血量数据
        ...
        if(Data::self_color == rm::ArmorColor::ARMOR_COLOR_RED){
            ...
            Data::enemy_info[0].is_live = game_robot_HP.blue_7_robot_HP > 0;
            Data::enemy_info[1].is_live = game_robot_HP.blue_1_robot_HP > 0;
            Data::enemy_info[2].is_live = game_robot_HP.blue_2_robot_HP > 0;
            Data::enemy_info[3].is_live = game_robot_HP.blue_3_robot_HP > 0;
            Data::enemy_info[4].is_live = game_robot_HP.blue_4_robot_HP > 0;
            Data::enemy_info[5].is_live = game_robot_HP.blue_5_robot_HP > 0;
        }
        else{
            ...
            Data::enemy_info[0].is_live = game_robot_HP.red_7_robot_HP > 0;
            Data::enemy_info[1].is_live = game_robot_HP.red_1_robot_HP > 0;
            Data::enemy_info[2].is_live = game_robot_HP.red_2_robot_HP > 0;
            Data::enemy_info[3].is_live = game_robot_HP.red_3_robot_HP > 0;
            Data::enemy_info[4].is_live = game_robot_HP.red_4_robot_HP > 0;
            Data::enemy_info[5].is_live = game_robot_HP.red_5_robot_HP > 0;
        }
